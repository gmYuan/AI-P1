...
print(str(obj))   # MyClass __str__
print(obj)        # MyClass __str__
print(repr(obj))  # MyClass __repr__
print(dir(obj))
# 检查数字 2 是否在 obj 对象中 (通过 __contains__ 方法实现)
print(f"2 in obj: {2 in obj}")                      # 2 in obj: True
print(f"2 in obj: {obj.__contains__(2)}")           # 2 in obj: True

# 检查数字 4 是否不在 obj 对象中 (通过 __contains__ 方法实现)
print(f"4 not in obj: {4 not in obj}")              # 4 not in obj: True
print(f"4 not in obj: {not obj.__contains__(4)}")   # 4 not in obj: True



# Q: __repr__ 和__str__什么区别
# A:  用的地方不一样
