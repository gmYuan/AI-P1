...
"""
# ---------------------------------------------------------------------------
# 1.25-2.1 进制转换- int（其他进制转换为 10进制）
...
# 示例4: 自定义进制转换
# 使用int()函数可以转换任意进制的数字
custom_base_str = "123"  # 3 + 10 + 25= 38
# 转换为5进制
...
# 二进制1010 转为五进制: 20
print(f"二进制{test_number} 转为五进制:{convert_base(test_number,2,5)}")
