...
# 删除cdba
text_with_punctuation = "cdba Hello a world"
print(f"\n原始字符串: '{text_with_punctuation}'")

# 删除cdba
cleaned_punctuation = text_with_punctuation.lstrip("abc")
print(f"删除abc后: '{cleaned_punctuation}'")
...
# 定义一个包含前置和后置abc的字符串 🌟🌟
my_string = "aabcdHello, World!   dvccab"
print("原始字符串:")
print(f"'{my_string}'")
